...
const coromant = Cormorant_Garamond({subsets:['latin'], style:'normal', weight:'400'})

export default function ProductLayout({children}) {
     const pathname = usePathname()
  return (
    <div className='container mx-auto min-w-[90%] max-w-[100%] flex bg-white overflow-hidden xsm:max-md:flex-col xsm:max-[400px]:p-2'>
        <div className={`${coromant.className}
         container min-w-[250px] max-w-[250px] bg-gradient-to-t from-gray-900 via-silver-400 to-gray-900
        rounded-md gap-x-4 gap-y-3 px-4 py-8 mt-20 text-white flex flex-col xsm:max-md:max-w-full`}>
